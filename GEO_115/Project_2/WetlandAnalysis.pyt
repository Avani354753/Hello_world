...
class WetlandsNearParks(object):
    ...
    def select_wetlands_in_buffer(self, wetlands_fc, buffer_layer):
        arcpy.management.SelectLayerByLocation(wetlands_fc, "WITHIN", buffer_layer, selection_type="NEW_SELECTION")
