...
class Toolbox(object):
    def __init__(self):
        ...
        self.label = "Fishing Access Point Analysis Toolbox"
        self.alias = "fishingaccesspointanalysis"
        self.tools = [FishingAccessPointNearParks] 

class FishingAccessPointNearParks(object):
    def __init__(self):
        """Define the tool (tool name is the name of the class)."""
        self.label = "Fishing Access Point Near National Parks"
        self.description = "Identifies Fishing Access Point within a specified distance of national parks."
    ...
    def getParameterInfo(self):
        ...
        wetlands_fc = arcpy.Parameter(
            displayName="Fishing Access Point Feature Class",
            name="fishingaccesspoints_fc",
            datatype="DEFeatureClass",
            parameterType="Required",
            direction="Input")
        ...
        buffer_distance = arcpy.Parameter(
            ...
            parameterType="Required",
            direction="Input")
        buffer_distance.value = "1000 Meters"  # Default value
    ...
    def execute(self, parameters, messages):
        ...
        try:
            ...
            fishingaccesspoints_fc = parameters[1].valueAsText
            ...
            fishingaccesspoints_layer = arcpy.management.MakeFeatureLayer(fishingaccesspoints_fc, "fishingaccesspoints_layer")
            self.select_wetlands_in_buffer(fishingaccesspoints_layer, buffer_layer)

            # Export selected wetlands to a new feature class
            self.export_selected_features(fishingaccesspoints_layer, output_fc)
    ...
    def select_wetlands_in_buffer(self, fishingaccesspoints_fc, buffer_layer):
        arcpy.management.SelectLayerByLocation(fishingaccesspoints_fc, "WITHIN", buffer_layer, selection_type="NEW_SELECTION")

    def export_selected_features(self, input_layer, output_fc):
